...
${OBJECTDIR}/ConsoleAppender.o: ConsoleAppender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConsoleAppender.o ConsoleAppender.cpp

${OBJECTDIR}/FileAppender.o: FileAppender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileAppender.o FileAppender.cpp
...
${OBJECTDIR}/SimpleFormatter.o: SimpleFormatter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimpleFormatter.o SimpleFormatter.cpp
