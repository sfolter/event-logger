...
${OBJECTDIR}/src/ConsoleAppender.o: src/ConsoleAppender.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ConsoleAppender.o src/ConsoleAppender.cpp

${OBJECTDIR}/src/FileAppender.o: src/FileAppender.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileAppender.o src/FileAppender.cpp

${OBJECTDIR}/src/Logger.o: src/Logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Logger.o src/Logger.cpp

${OBJECTDIR}/src/SimpleFormatter.o: src/SimpleFormatter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SimpleFormatter.o src/SimpleFormatter.cpp
